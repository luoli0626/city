	...
	$(function(){
    	...
    	columns:[[   
        {
			...
			formatter:function(value,rec,i){					
				...
				btnHtml+="<a href='javascript:removeMorer();' plain='true' iconcls='icon-remove' class='easyui-linkbutton l-btn l-btn-plain'><span class='l-btn-left'><span class='l-btn-text icon-remove' style='padding-left: 20px;'>部署</span></span></a>";
				
				btnHtml+="<a href='javascript:removeMorer();' plain='true' iconcls='icon-remove' class='easyui-linkbutton l-btn l-btn-plain'><span class='l-btn-left'><span class='l-btn-text icon-remove' style='padding-left: 20px;'>导出</span></span></a>";
		...
		<div id="toolbar" class="datagrid-toolbar" style="height: auto;">
			<fieldset class="my_fieldset" >
				...
				<table  id="table1" name="table1">
					<tr>
						<td width="70px;">流程名称：</td>
						<td colspan="2">
						<input name="Name" id="Name" class="basic_input" />
						</td>
						<td align="left">
							&nbsp;
