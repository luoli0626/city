		...
		<tr>
			<td><div align="center">
					<span style="float:left;margin-left:10px;">
						<a href="javascript:backTo();" style="text-decoration:none;"><img border="0" src="<%=request.getContextPath()%>/static/images/back.png" style="line-height: 20px;margin-bottom:-6px;"><font style="color: #fff;">返回</font></a>
					</span>
