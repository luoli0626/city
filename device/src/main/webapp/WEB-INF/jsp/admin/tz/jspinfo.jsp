...
<body topmargin="0" background="<%=request.getContextPath()%>/static/images/bgcolor.gif" >

	<table width="760" height="20" border="0" cellpadding="0" cellspacing="0" align="center">
		<tr>
			<td align="center">选项：<a href="#ServerInfo">服务器相关参数</a> | <a href="#JAVAInfo">JAVA相关参数</a> | <a href="#Paramter">参数查询</a> | <a href="#ServerAbility">服务器运算能力</a> | <a href="#ISpeedTest">服务器连接速度</a> | <a href="javascript:location.reload()">刷新</a>  | <a href="<%=request.getContextPath()%>/menu/toTz">内存使用情况</a> <a name="ServerInfo"></a></td>
		</tr>
	</table>
	...
	<table width="760" border="0" align="center" cellpadding="0" cellspacing="1" class="tableBorder">
		<tr>
			<td background="<%=request.getContextPath()%>/static/images/h.gif" height="20">
	...
	<table width="760" border="0" align="center" cellpadding="0" cellspacing="1" class="tableBorder">
		<tr>
			<td background="<%=request.getContextPath()%>/static/images/h.gif">
				<table border=0 width=100% cellspacing=1 cellpadding=3>
					<tr>
